    ...
    return(
       <div className='flex justify-between w-11/12 max-w-[1160px] py-10 mx-auto gap-x-12 gap-y-0' > 
        ...
        border border-richblack-700 px-[12px] py-[8px] gap-x-2 mt-6 '>
            <FcGoogle></FcGoogle><p>Sign Up with Google</p></button>
        
        </div>
        <div className='relative w-11/12 max-w-[450px] '>
            <img src=  {frameImage} alt='frame' width={540}height={540} loading='lazy'></img>
            <img src={image} width={540} height={490} loading='lazy' className='absolute top-4 right-4'></img>
        </div>
